...
from transformation.file_image_generator import create_image_lists, create_image_lists_non_sorted
...
class LmdbTransformer:
    def __init__(self, validation_pct, valid_image_formats, image_dir=None, data_format=None, scalar=255.0, non_sorted=None):
        if image_dir is not None:
            if non_sorted is True:
                self.image_lists = create_image_lists_non_sorted(image_dir, validation_pct, valid_image_formats, verbose=0)
